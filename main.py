...
@dp.message_handler(lambda message: message.text in ['моя стихия', 'Моя стихия'])
...
@dp.message_handler(lambda message: message.text.lower().startswith('купоны купить'))
async def putbank_s(message: types.Message):
    await putbank(message)


@dp.message_handler(lambda message: message.text.lower().startswith('купоны продать'))
...
@dp.message_handler(lambda message: message.text.lower().startswith('продать мощь') or message.text.lower().startswith('мощь продать'))
async def sellbtc_s(message: types.Message):
    await sellbtc(message)


@dp.message_handler(lambda message: message.text.lower().startswith('купить мощь') or message.text.lower().startswith('мощь купить'))
async def buybtc_s(message: types.Message):
    await buybtc(message)


@dp.message_handler(lambda message: message.text.lower().startswith('курс мощи') or message.text.lower().startswith('мощи курс'))
