...
💵 Текущий курс: 1 RUB = 1 Жетон
💸 Валюта: 1 Жетон можно обменять на 1.000.000.000.000$

🪙 Обмен Жетонов на валюту: Обменять [количество]

🏆 Привилегии:
1️⃣ Стандартный маг | 250 Жетонов
2️⃣ Золотой маг | 500 Жетонов
3️⃣ Платиновый маг | 750 Жетонов
4️⃣ Admin Status | 1.500 Жетонов

🔝Покупка: Купить привилегию [номер]

⚡ Энергия:
    - 20 энергии | 15 Жетонов
     🔝 Покупка: Купить флягу 1
    - 60 энергии | 35 Жетонов
     🔝 Покупка: Купить флягу 2

🚧 Лимит:
 - 75.000.000.000.000 | 100 Жетонов
🔝 Покупка: Купить лимит 1

💰Ваш баланс: {ecoins} Жетонов
